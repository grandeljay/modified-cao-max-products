...
$translations->add('ALLOWED_QUANTITY_EXCEEDED', 'Die maximal erlaubte Stückzahl in Höhe von <strong>%d</strong> für <strong>%s</strong> wurde überschritten. Die Stückzahl wurde <strong>nicht</strong> dem Warenkorb hinzugefügt.');
$translations->define();
